...
FactoryBot.create(
  :question,
  question: "What is %{questioner} favourite film?",
...
FactoryBot.create(
  :question,
  question: "What is %{questioner} favourite TV show?",
...
FactoryBot.create(
  :question,
  question: "What is %{questioner} favourite music genre?",
  options: "Pop, Rock, Hip Hop, Country, Jazz, Classical, Electronic, Reggae, Metal, R&B"
)

FactoryBot.create(
  :question,
  question: "What is %{questioner} favourite cuisine?",
...
FactoryBot.create(
  :question,
  question: "What is %{questioner} favourite type of music?",
